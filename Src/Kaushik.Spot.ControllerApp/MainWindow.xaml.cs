    ...
    public partial class MainWindow : Window
    {
        ...
        private void switchButton1_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                if (switchOn)
                {
                    switchButton1.Content = "Switch Off First Item";
                }
                else
                {
                    switchButton1.Content = "Switch On First Item";
                }
            }
            catch (Exception error)
            {
        ...
        private void switchButton2_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                if (switchOn)
                {
                    switchButton2.Content = "Switch Off Second Item";
                }
                else
                {
                    switchButton2.Content = "Switch On Second Item";
                }
            }
            catch (Exception error)
            {
        ...
        private void switchButton3_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                if (switchOn)
                {
                    switchButton3.Content = "Switch Off Third Item";
                }
                else
                {
                    switchButton3.Content = "Switch On Third Item";
                }
            }
            catch (Exception error)
            {
        ...
        private void switchButton4_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                if (switchOn)
                {
                    switchButton3.Content = "Switch Off Forth Item";
                }
                else
                {
                    switchButton3.Content = "Switch On Forth Item";
                }
            }
            catch (Exception error)
            {
